        ...
        <li class="tl_item Project_card" v-for="(project,index) in projects" :key= "index" >
          ...
          <div :class="[(project.Status ==='Online') ? 'card-online' : 'card-offline' , 'card' , 'card-dark']">
            ...
            <div class="card-body">
              ...
              <div class="pos-rb">
                <b>{{project.Published}} / {{project.Info}}</b>                
              </div>
              <!-- Button -->
      ...
      return {
        projects: [
        {
          ...
          },
          {
            ...
            Type: 'Chemicle Business Company Website',
            Tech: ['html5', 'css3', 'js'],
            Image: 'uci.jpg',
          ...
          },
          {
            ...
            Type: 'A Clothing Company Website',
          ...
          },
          {
            ...
            Type: 'My Old Tips and Tricks Blog',
            Tech: ['html5', 'css3', 'blogger'],
            Image: 'dynamo.jpg',
